...
#define SI4463_SPI_NCS		GPIOB_Pin_0
#define SI4463_SPI_SCK		GPIOB_Pin_1
#define SI4463_SPI_MOSI		GPIOB_Pin_3
#define SI4463_SPI_MISO		GPIOB_Pin_2
/* End of properties */
...
void init_SI446X_SPI(uint8_t speed);					//@ hy PB port SPI
