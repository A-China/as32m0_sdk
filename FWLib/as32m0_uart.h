...
#ifndef __AS32M0_UART_H__
#define __AS32M0_UART_H__
...
/*
 * Data read register UARTDR		//@ 0x00
 */
...
#define UART_INTCLR_RECEIVE            0x10   /* Receive interrupt */
#define UART_INTCLR_TRANSMIT           0x20   /* Transmit interrupt */
...
void apUART_Set_TXFIFO_WATERLEVEL(UART_TypeDef* pBase, uint16_t water_level);
void apUART_Set_RXFIFO_WATERLEVEL(UART_TypeDef* pBase, uint16_t water_level);
void apUART_Enable_FIFO(UART_TypeDef* pBase);
void apUART_Disable_FIFO(UART_TypeDef* pBase);
void apUART_Enable_MASTER(UART_TypeDef* pBase);
void apUART_Disable_MASTER(UART_TypeDef* pBase);
void apUART_Enable_TRANSMIT(UART_TypeDef* pBase);
void apUART_Disable_TRANSMIT(UART_TypeDef* pBase);
void apUART_Enable_RECEIVE(UART_TypeDef* pBase);
void apUART_Disable_RECEIVE(UART_TypeDef* pBase);
...
void apUART_INT_TX_CLR(UART_TypeDef* pBase);
void apUART_INT_RX_CLR(UART_TypeDef* pBase);

uint8_t apUART_Check_BUSY(UART_TypeDef* pBase);
void apUART_Initialize (UART_TypeDef* pBase, UART_sStateStruct* UARTx);
void apUART_SendData(UART_TypeDef* pBase, uint8_t Data);
uint8_t apUART_ReceData(UART_TypeDef* pBase);
void apUART_DMAModeSet(UART_TypeDef* pBase,UART_eDMAMode DMAMode);
void apUART_LoopModeSet(UART_TypeDef* pBase,UART_eLoopMode LoopMode);

void UART_SendData(UART_TypeDef* pBase, uint8_t Data);
uint8_t UART_ReceData(UART_TypeDef* pBase);
void UART_DMAModeSet(UART_TypeDef* pBase,UART_eDMAMode DMAMode);
