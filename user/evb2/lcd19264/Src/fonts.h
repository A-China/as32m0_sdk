...
//---- comment out fonts that are not used to save memory -------------------------------------
			// The font has Cyrillic and Latin
 ...
 * 
 */
// Necessarily needed #include "main.h" 
// so as not to separately include files associated with MK and standard libraries
#include <string.h>
#include <stdlib.h>
#include <stdint.h>
